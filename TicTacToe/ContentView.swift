//
//  ContentView.swift, the user interface of the app.
//  TicTacToe
//
...
struct ContentView: View {
    ...
    @ObservedObject var viewModel: ViewModel    //observes the ViewModel and TicTacToeModel for any changes to the game state
    ...
    var body: some View {
        ZStack {
            ...
            Color(red: 1.0, green: 1.0, blue: 0.88).edgesIgnoringSafeArea(.all) // RGB for pale yellow
                ...
                HStack {
                    Button(action: {
                        ...
                        Image(systemName: icon)
                            ...
                            .cornerRadius(10)
                            .foregroundColor(Color.blue)    //changed the icon color for haptic feedback to blue
